...
export const mockCategories: Category[] = [
  {
    id: "1",
    name: "雑談",
    description: "何でも気軽に話せる場所",
    threadCount: 42,
  },
  {
    id: "2",
    name: "テクノロジー",
    description: "技術的な話題や最新のトレンド",
    threadCount: 28,
  },
  {
    id: "3",
    name: "ニュース",
    description: "時事ネタや話題のニュース",
    threadCount: 35,
  },
  ...
  "2": [
    {
      ...
      username: "通りすがり",
      content:
        "Next.js 15がリリースされましたが、使ってる人いますか？\n新機能についての感想を聞きたいです。",
